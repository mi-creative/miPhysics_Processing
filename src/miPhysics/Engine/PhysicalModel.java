...
public class PhysicalModel {
	...
	public Mass getMass(String name){
		...
		if (m == null){
			System.out.println("The mass " + name + " doesn't exist. ");
		}
		return m;
	}
	...
	public Interaction getInteraction(String name){
		...
		Interaction inter = m_intLabels.get(name);
		if (inter == null){
			System.out.println("The interaction " + name + " doesn't exist. ");
		}
		return inter;
	}
	...
	protected int getNumberOfLinks(){
		return this.m_interactions.size();
	}
...
// * index in the Mass and Interaction module tables. See example: HelloMass
// *
// *
// *
// */
...
//
//	/* List of Mats and Links that compose the physical model */
//	private ArrayList<Mass> mats;
//	private ArrayList<Interaction> links;
//
//	/*
//	 * Mass and Interaction index lists: matches module name to index of module in ArrayList
//	 */
//	private ArrayList<String> matIndexList;
//	private ArrayList<String> linkIndexList;
//
//
//	private ArrayList<Listener3D> listeners;
//	private ArrayList<String> listenerIndexList;
//
//	private ArrayList<Driver3D> drivers;
//	private ArrayList<String> driverIndexList;
//
//
//	/* Super dirty but works as a dummy for plane-based interactions */
//	private Mass fakePlaneMat;
//
//	/* The simulation rate (mono rate only) */
//	private int simRate;
//
...
//	public PhysicalModel(int sRate, int displayRate, paramSystem sys) {
//		/* Create empty Mass and Interaction arrays */
//		mats = new ArrayList<Mass>();
//		links = new ArrayList<Interaction>();
//		matIndexList = new ArrayList<String>();
//		linkIndexList = new ArrayList<String>();
//
//		drivers = new ArrayList<Driver3D>();
//		listeners = new ArrayList<Listener3D>();
//		driverIndexList = new ArrayList<String>();
//		listenerIndexList = new ArrayList<String>();
//
//
//		/* Initialise the Mass and Interaction subset groups */
...
//
//	/**
//	 * Get the index of a Mass module identified by a given string.
//	 *
//	 * @param name
//	 *            Mass module identifier.
//	 * @return
//	 */
...
//
//	/**
//	 * Get the index of a Interaction module identified by a given string.
//	 *
//	 * @param name
//	 *            Interaction module identifier.
//	 * @return
//	 */
...
//
//	/**
//	 * Get the position of a Mass module identified by its name.
//	 *
//	 * @param masName
//	 *            identifier of the Mass module.
...
//
//	/**
//	 * Get the force of a Mass module identified by its index.
//	 *
//	 * @param mat_index
//	 *            index of the Mass module.
...
//
//	/**
//	 * Get number of Mass modules in current model.
//	 *
//	 * @return the number of Mass modules in this model.
//	 */
...
//
//	/**
//	 * get number of Interaction modules in current model.
//	 *
//	 * @return the number of Interaction modules in this model.
//	 */
...
//
//	/**
//	 * Check if a Mass module with a given identifier exists in the current model.
//	 *
//	 * @param mName
//	 *            the identifier of the Mass module.
...
//
//	/**
//	 * Check if a Interaction module with a given identifier exists in the current model.
//	 *
//	 * @param lName
//	 *            the identifier of the Interaction module.
//	 * @return True of the module exists, False otherwise.
//	 */
...
//
//	/**
//	 * Find and return a list of all Interaction modules that match a given name pattern.
...
//	 *
//	 * @param tag
//	 *            the String that is searched for within the interaction name tags.
//	 * @return the Interaction ArrayList of all the modules that contain the identifier
//	 *         tag.
//	 */
//	private ArrayList<Interaction> findAllLinksContaining(String tag) {
//
//		ArrayList<Interaction> newlist = new ArrayList<Interaction>();
//
//		for (int i = 0; i < links.size(); i++) {
...
//
//	/**
//	 * Find and return a list of all Mass modules that match a given name pattern.
//	 * This can be used to group modules with a given label in order to manipulate
//	 * them together (modify parameters, etc.) Note: This method is probably very
//	 * slooooow.
//	 *
//	 * @param tag
//	 *            the String that is searched for within the Mass name tags.
//	 * @return the Mass ArrayList of all the modules that contain the identifier tag.
//	 */
//	private ArrayList<Mass> findAllMatsContaining(String tag) {
//
//		ArrayList<Mass> newlist = new ArrayList<Mass>();
//
...
//
//	/**
//	 * Check the type (mass, ground, osc) of Mass module at index i
//	 *
//	 * @param i
//	 *            the index of the Mass module.
//	 * @return the type of the Mass module.
//	 */
//	public massType getMatTypeAt(int i) {
//		if (getNumberOfMats() > i)
//			return mats.get(i).getType();
//		else
//			return massType.UNDEFINED;
//	}
//
//	/**
//	 * Get the name (identifier) of the Mass module at index i
//	 *
//	 * @param i
//	 *            the index of the Mass module.
...
//
//	/**
//	 * Get the 3D position of Mass module at index i. Returns a zero filled 3D Vector
...
//
//	/**
//	 * Get the 3D delayed position of the Mass module at index i. Returns a zero filled 3D Vector
//	 * if the Mass is not found.
//	 *
//	 * @param i
//	 *            the index of the Mass module
...
//	// !!!
//
//	public Mass getMat(int i){
//		return mats.get(i);
//	}
//
//	/**
//	 * Get the velocity of the Mass module at index i. Returns a zero filled 3D Vector
//	 * if the Mass is not found.
//	 *
//	 * @param i
//	 *            the index of the Mass module
...
//
//
//	public Vect3D getMatVelPerSampleAt(int i) {
//		if (getNumberOfMats() > i) {
//			Vect3D vel = new Vect3D();
//			vel.set(mats.get(i).getPos());
//			return (vel.sub(mats.get(i).getPosR()));
//		}
//		else
//			return new Vect3D(0., 0., 0.);
//	}
//
//	/**
//	 * Get the 3D force of Mass module at index i. Returns a zero filled 3D Vector
//	 * if the Mass is not found.
//	 *
//	 * @param i
//	 *            the index of the Mass module
...
//
//	/**
//	 * Check the type (spring, rope, contact...) of Interaction module at index i
//	 *
//	 * @param i
//	 *            index of the Interaction module.
//	 * @return the module type.
//	 */
//	public interType getLinkTypeAt(int i) {
//		if (getNumberOfLinks() > i)
//			return links.get(i).getType();
//		else
//			return interType.UNDEFINED;
//	}
//
//	/**
//	 * Get the name (identifier) of the Interaction module at index i
//	 *
//	 * @param i
//	 *            index of the Interaction module.
...
//
//	/**
//	 * Get the position of the Mass connected to the 1st end of the Interaction at index i.
//	 *
//	 * @param i
//	 *            the index of the Interaction.
//	 * @return the 3D position of the Mass connected to the 1st end of this Interaction.
//	 */
...
//
//	/**
//	 * Get the position of the Mass connected to the 2nd end of the Interaction at index i.
//	 *
//	 * @param i
//	 *            the index of the Interaction.
//	 * @return the 3D position of the Mass connected to the 2nd end of this Interaction.
//	 */
...
//
//	/**
//	 * Get the index of the Mass connected to the first input of a Interaction Module
//	 * @param i index of the Interaction Module.
//	 * @return the index of the Mass module (in the Mass list)
//	 */
//	public int getLinkMat1IdxAt(int i) {
//		if (getNumberOfLinks() > i) {
//			Mass theMat1 = links.get(i).getMat1();
...
//
//	/**
//	 * Get the index of the Mass connected to the second input of a Interaction Module
//	 * @param i index of the Interaction Module.
//	 * @return the index of the Mass module (in the Mass list)
//	 */
//	public int getLinkMat2IdxAt(int i) {
//		if (getNumberOfLinks() > i) {
//			Mass theMat2 = links.get(i).getMat2();
...
//
//	/**
//	 * Get the name of the Mass connected to the first input of a Interaction Module
//	 * @param i index of the Interaction Module
//	 * @return the name of the Mass
//	 */
...
//
//	/**
//	 * Get the name of the Mass connected to the second input of a Interaction Module
//	 * @param i index of the Interaction Module
//	 * @return the name of the Mass
//	 */
...
//	 */
//	public int addMass3D(String name, double mass, double size, Vect3D initPos, Vect3D initVel) {
//		try {
...
//				throw new Exception("The module name already exists!");
//			}
//			mats.add(new Mass3D(mass, size, initPos, constructDelayedPos(initPos, initVel), friction, g_scaled));
...
//	 * @return 0 if everything goes well.
//	 */
//	public int addMass2DPlane(String name, double mass, double size, Vect3D initPos, Vect3D initVel) {
//		try {
//			if (matIndexList.contains(name) == true) {
//
//				System.out.println("The module name already exists!");
//				throw new Exception("The module name already exists!");
//			}
//			mats.add(new Mass2DPlane(mass, size, initPos, constructDelayedPos(initPos, initVel), friction, g_scaled));
//			matIndexList.add(name);
//		} catch (Exception e) {
//			System.out.println("Error adding Module " + name + ": " + e);
//			System.exit(1);
...
//	 * @return 0 if everything goes well.
//	 */
//	public int addMass1D(String name, double mass, double size, Vect3D initPos, Vect3D initVel) {
//		try {
//			if (matIndexList.contains(name) == true) {
//
//				System.out.println("The module name already exists!");
//				throw new Exception("The module name already exists!");
//			}
//			mats.add(new Mass1D(mass, size, initPos, constructDelayedPos(initPos, initVel), friction, g_scaled));
//			matIndexList.add(name);
//		} catch (Exception e) {
//			System.out.println("Error adding Module " + name + ": " + e);
//			System.exit(1);
...
//	 * @return 0 if everything goes well.
//	 */
//	public int addMass3DSimple(String name, double mass, double size, Vect3D initPos, Vect3D initVel) {
//		try {
//			if (matIndexList.contains(name) == true) {
//
//				System.out.println("The module name already exists!");
//				throw new Exception("The module name already exists!");
//			}
//			mats.add(new Mass3DSimple(mass, size, initPos, constructDelayedPos(initPos, initVel)));
//			matIndexList.add(name);
//
//		} catch (Exception e) {
//			System.out.println("Error adding Module " + name + ": " + e);
...
//
//	/**
//	 * Add a fixed point to the model (a Mass module that will never move from it's
//	 * initial position).
//	 *
//	 * @param name
...
//	 * @return 0 if everything goes well.
//	 */
//	public int addGround3D(String name, double size, Vect3D initPos) {
//		try {
//			if (matIndexList.contains(name) == true) {
//
//				System.out.println("The module name already exists!");
//				throw new Exception("The module name already exists!");
//			}
//			mats.add(new Ground3D(size, initPos));
//			matIndexList.add(name);
//
//		} catch (Exception e) {
//			System.out.println("Error adding Module " + name + ": " + e);
...
//	}
//
//	public int addGround1D(String name, double size, Vect3D initPos) {
//		try {
//			if (matIndexList.contains(name) == true) {
//
//				System.out.println("The module name already exists!");
//				throw new Exception("The module name already exists!");
//			}
//			mats.add(new Ground1D(size, initPos));
//			matIndexList.add(name);
//
//		} catch (Exception e) {
//			System.out.println("Error adding Module " + name + ": " + e);
...
//	 * @return 0 if everything goes well.
//	 */
//	public int addOsc3D(String name, double mass, double size, double K, double Z, Vect3D initPos, Vect3D initVel) {
//
...
//				throw new Exception("The module name already exists!");
//			}
//			mats.add(new Osc3D(mass, size, K, Z, initPos, constructDelayedPos(initPos, initVel), friction, g_scaled));
//			matIndexList.add(name);
//
//		} catch (Exception e) {
//			System.out.println("Error adding Module " + name + ": " + e);
...
//	}
//
//	public int addOsc1D(String name, double mass, double size, double K, double Z, Vect3D initPos, Vect3D initVel) {
//
//		if (unit_system == paramSystem.REAL_UNITS) {
//			K = K / (simRate * simRate);
//			Z = Z / simRate;
...
//				throw new Exception("The module name already exists!");
//			}
//			mats.add(new Osc1D(mass, size, K, Z, initPos, constructDelayedPos(initPos, initVel), friction, g_scaled));
//			matIndexList.add(name);
//
//		} catch (Exception e) {
//			System.out.println("Error adding Module " + name + ": " + e);
...
//
//
//	public int addPosInput3D(String name, double size, Vect3D initPos) {
//		try {
//			if (matIndexList.contains(name) == true) {
//
//				System.out.println("The module name already exists!");
//				throw new Exception("The module name already exists!");
//			}
//			mats.add(new PosInput3D(size, initPos));
//			matIndexList.add(name);
//		} catch (Exception e) {
//			System.out.println("Error adding Module " + name + ": " + e);
//			System.exit(1);
...
//	 *            stiffness.
//	 * @param m1_Name
//	 *            name of Mass module connected to 1st end
//	 * @param m2_Name
//	 *            name of Mass module connected to 2nd end
...
//	 * @return O if all goes well.
//	 */
//	public int addContact3D(String name, double paramK, double paramZ, String m1_Name, String m2_Name) {
//
//		if (unit_system == paramSystem.REAL_UNITS) {
//			paramK = paramK / (simRate * simRate);
//			paramZ = paramZ / simRate;
...
//		int mat2_index = getMatIndex(m2_Name);
//		try {
//			links.add(new Contact3D(paramK, paramZ, mats.get(mat1_index), mats.get(mat2_index)));
//			linkIndexList.add(name);
//		} catch (Exception e) {
...
//	 * @param m1_Name
//	 *            name of the Mass module connected to this Plane.
//	 * @return
//	 */
...
//
//
//	public int addListener3D(String name, String m1_Name) {
//
//		int mat1_index = getMatIndex(m1_Name);
//
//		try {
//			listeners.add(new Listener3D(mats.get(mat1_index)));
//			listenerIndexList.add(name);
//		} catch (Exception e) {
//			System.out.println("Error allocating the Listener : " + e);
//			System.exit(1);
//		}
//		return 0;
//	}
//
//
//	public int addDriver3D(String name, String m1_Name) {
//
//		int mat1_index = getMatIndex(m1_Name);
//
//		try {
//			drivers.add(new Driver3D(mats.get(mat1_index)));
//			driverIndexList.add(name);
//		} catch (Exception e) {
//			System.out.println("Error allocating the Driver : " + e);
//			System.exit(1);
//		}
//		return 0;
//	}
//
//
//	public void driveForceAt(int i, Vect3D frc){
//		if (i < drivers.size())
//			drivers.get(i).applyFrc(frc);
//	}
//
//	public void drivePosAt(int i, Vect3D pos){
//		if (i < drivers.size())
//			drivers.get(i).applyPos(pos);
//	}
//
//	public Vect3D listenForceAt(int i){
//		if (i < listeners.size())
//			return listeners.get(i).listenFrc();
//		else
//			return new Vect3D(0,0,0);
//	}
//
//	public Vect3D listenPosAt(int i){
//		if (i < listeners.size())
//			return listeners.get(i).listenPos();
//		else
//			return new Vect3D(0,0,0);
//	}
//
//
//	public void addLink(String name, Interaction l){
//
//	}
//
//
...
//
//	/**
//	 * Remove Mass module at index mIndex from the model. This function is private: a
//	 * Mass module cannot safely be removed without removing associated Links,
//	 * therefore a higher level function is provided for the user.
//	 *
//	 * @param mIndex
//	 *            index of the Mass module to remove.
//	 * @return 0 if success, throws error if Mass cannot be found or removed.
//	 */
...
//
//	/**
//	 * Remove Mass module (identified by name) from the Model This function is
//	 * private: a Mass module cannot safely be removed without removing associated
//	 * Links, therefore a higher level function is provided for the user.
//	 *
//	 * @param name
//	 *            identifier of the Mass module to remove.
...
//	/**
//	 * Remove a Interaction module from the Model (at lIndex)
//	 *
//	 * @param lIndex
//	 *            the index of the Interaction module to remove
//	 * @return 0 if success, throws error otherwise.
//	 */
...
//			} catch (Exception e) {
//				System.out.println("Error removing interaction Module at " + lIndex + ": " + e);
//				System.exit(1);
//			}
//		}
//		return 0;
...
//	// Links can be removed without further steps: public function
//	/**
//	 * Remove a Interaction module from the Model (by name)
//	 *
//	 * @param name
//	 *            identifier of the Interaction module to remove.
//	 * @return 0 if success, throws error otherwise.
//	 */
...
//
//	/**
//	 * Remove a Mass module along with any connected Links.
//	 *
//	 * @param mIndex
//	 *            the index of the Mass module to remove.
//	 * @return 0 if success, throws error otherwise.
//	 */
...
//	 *
//	 * @param mName
//	 *            name of the Mass module to remove.
...
//			double size = mats.get(mat_index).getSize();
//
//			mats.set(mat_index, new Ground3D(size, pos));
//
//		} catch (Exception e) {
...
//
//	/**
//	 * Set (or change) the resting distance of a Interaction module.
//	 *
//	 * @param name
...
//		} catch (Exception e) {
//			System.out.println("Issue changing interaction distance!");
//			System.exit(1);
//		}
//	}
//
//	/**
//	 * Set all parameters of a Interaction module with given name identifier.
//	 *
//	 * @param tag
...
//		ArrayList<Interaction> tmplist = findAllLinksContaining(tag);
//
//		// Update the parameters of all these links
//		for (Interaction ln : tmplist) {
...
//
//	/**
//	 * Set mass parameters for Mass modules with a given name pattern.
//	 *
//	 * @param tag
...
//
//		// Create a list with all the links to modify
//		ArrayList<Mass> tmplist = findAllMatsContaining(tag);
//
//		// Update the parameters of all these links
//		for (Mass ma : tmplist) {
//			ma.changeMass(mass);
...
//
//	/**
//	 * Set Interaction parameters for the module with a given identifier
//	 *
//	 * @param name
...
//		} catch (Exception e) {
//			System.out.println("Issue changing interaction params!");
//			System.exit(1);
//		}
//	}
//
//	/**
//	 * Set the stiffness value for a Interaction module at a given index.
//	 *
//	 * @param index
//	 *            index of the Interaction module to modify
//	 * @param stiff
...
//		} catch (Exception e) {
//			System.out.println("Issue changing interaction stiffness!");
//			System.exit(1);
//		}
//	}
//
//
//	/**
//	 * Get stiffness of a interaction module at given index
//	 * @param index
...
//
//		if (index >= links.size()) {
//			System.out.println("Trying to get stiffness in out of bounds interaction.");
//			return 0;
//		}
//
...
//
//	/**
//	 * Set the stiffness value for a Interaction module with given identifier.
//	 *
//	 * @param name
//	 *            name of the Interaction module.
//	 * @param stiff
//	 *            stiffness value.
//	 */
...
//
//	/**
//	 * Set the damping value for a Interaction module with given identifier.
//	 *
//	 * @param index
//	 *            identifier of the Interaction module.
//	 * @param damp
//	 *            damping parameter.
//	 */
...
//		} catch (Exception e) {
//			System.out.println("Issue changing interaction damping!");
//			System.exit(1);
//		}
//	}
//
//
//	/**
//	 * Get damping of a interaction module at given index
//	 * @param index
...
//
//		if (index >= links.size()) {
//			System.out.println("Trying to get damping in out of bounds interaction.");
//			return 0;
//		}
//
...
//
//	/**
//	 * Set the damping value for a Interaction module with given name.
//	 *
//	 * @param name
//	 *            name of the Interaction module.
//	 * @param damp
...
//
//	/**
//	 * Change mass parameter for a given Mass module identified by index.
//	 *
//	 * @param index
//	 *            the index of the Mass module.
//	 * @param mass
...
//
//	/**
//	 * Get mass of a Mass module at given index
//	 * @param index
//	 * @return the stiffness parameter
//	 */
...
//
//
//	public double getMatSizeAt(int index) {
//
//		if (index >= mats.size()) {
//			System.out.println("Trying to get size in out of bounds mat.");
//			return 0;
//		}
//
//		return mats.get(index).getSize();
//
//	}
//
//	/**
//	 * Get stiffness of a Mass module at given index (if it has a stiffness value)
//	 * @param index
//	 * @return the stiffness parameter
//	 */
...
//		}
//
//		massType type = getMatTypeAt(index);
//
//		if (type == massType.OSC3D)
//			return ((Osc3D) mats.get(index)).getStiffness();
//		else if (type == massType.OSC1D)
...
//
////	/**
////	 * Get damping of a Mass module at given index (if it has a stiffness value)
////	 * @param index
////	 * @return the damping parameter
////	 */
...
//
//	/**
//	 * Change mass parameter for a given Mass module identified by name.
//	 *
//	 * @param name
...
//
//	/**
//	 * Set stiffness of a Mass module at given index (if it has a stiffness value)
...
//
//	/**
//	 * Set damping of a Mass module at given index (if it has a stiffness value)
//	 * @param index index of the module
...
//
//	/**
//	 * Set size of a Mass module at given index
//	 * @param index index of the module
//	 * @param size new radius to set
//	 */
//	public void setMatRadiusAt(int index, double size) {
//
//		if (index >= mats.size()) {
//			System.out.println("Trying to set radius value in out of bounds mat.");
//			return;
//		}
//
//		mats.get(index).setSize(size);
//	}
//
//
//
...
//
//		if (index >= links.size()) {
//			System.out.println("Trying to get orientation value in out of bounds interaction.");
//			return 0;
//		}
//
//		interType type = getLinkTypeAt(index);
//
//		if (type == interType.PLANECONTACT3D)
...
//
//		if (index >= links.size()) {
//			System.out.println("Trying to get position value in out of bounds interaction.");
//			return 0;
//		}
//
//		interType type = getLinkTypeAt(index);
...
//	 */
//	public void getAllMatsOfType(ArrayList<PVector> mArray, massType m) {
//		mArray.clear();
//		Mass mat;
...
//	 *            the module type that we are looking for.
//	 */
//	public void getAllMatSpeedsOfType(ArrayList<PVector> pArray, ArrayList<PVector> vArray, massType m) {
//		pArray.clear();
//		vArray.clear();
//		Mass mat;
//		Vect3D pos = new Vect3D();
...
//	 *
//	 * Quite inefficient method (checks all Mass modules for a given type)
//	 *
//	 * @param pArray
//	 *            the position ArrayList (that will be cleared and refilled).
//	 * @param vArray
...
//	 *            the module type that we are looking for.
//	 */
//	public void createPosSpeedArraysForModType(ArrayList<PVector> pArray, ArrayList<PVector> vArray, massType m) {
//		pArray.clear();
//		vArray.clear();
//		Mass mat;
//		Vect3D pos = new Vect3D();
...
//	 */
//	public void updatePosSpeedArraysForModType(ArrayList<PVector> pArray, ArrayList<PVector> vArray, massType m) {
//		Mass mat;
//		Vect3D pos = new Vect3D();
//		int arrayIndex = 0;
//		for (int i = 0; i < mats.size(); i++) {
...
//		Mass2DPlane tmp5;
//		for (int i = 0; i < mats.size(); i++) {
//			if (mats.get(i).getType() == massType.MASS3D) {
//				tmp = (Mass3D) mats.get(i);
//				tmp.updateFriction(frZ);
//			} else if (mats.get(i).getType() == massType.OSC3D) {
//				tmp2 = (Osc3D) mats.get(i);
//				tmp2.updateFriction(frZ);
//			} else if (mats.get(i).getType() == massType.MASS1D) {
//				tmp3 = (Mass1D) mats.get(i);
//				tmp3.updateFriction(frZ);
//			} else if (mats.get(i).getType() == massType.OSC1D) {
//				tmp4 = (Osc1D) mats.get(i);
//				tmp4.updateFriction(frZ);
//			} else if (mats.get(i).getType() == massType.MASS2DPLANE) {
...
//
//	/**
//	 * Trigger a force impulse on a given Mass module (identified by index).
//	 *
//	 * @param index
...
//	}
//
//	public void triggerForceImpulse(int index, Vect3D v) {
//		try {
//			mats.get(index).applyExtForce(v);
//		} catch (Exception e) {
//			System.out.println("Issue during force impuse trigger");
//			System.exit(1);
//		}
...
//
//	/**
//	 * Trigger a force impulse on a given Mass module.
//	 *
//	 * @param name
...
//	 *
//	 * @param grav
//	 *            the scalar value of the gravity applied to Mass modules within the
//	 *            model.
//	 */
...
//		Osc3D tmp;
//		if (mats.get(i).getType() == massType.OSC3D) {
...
//
//	/**
//	 * Get the current distance (length) of a Interaction type module
//	 *
//	 * @param i
//	 *            index of the Interaction to observe.
...
//
//	/**
//	 * Get the current elongation (length minus resting length) of a Interaction type module
//	 *
//	 * @param i
//	 *            index of the Interaction to observe.
...
//
//		if (getNumberOfLinks() > i)
//			return links.get(i).getElongation();
//		else
//			return 0;
//	}
//
//	/**
//	 * Get the resting distance of a Interaction type module
//	 *
//	 * @param i
//	 *            index of the Interaction to observe.
...
//
//	/**
//	 * Force a Mass module to a given position (with null velocity).
//	 *
//	 * @param matName
...
//
//	/**
//	 * Create an empty Mass module subset item. Module indexes will be associated to
//	 * this specific key later.
//	 *
//	 * @param name
//	 *            the identifier for this subset.
...
//
//	/**
//	 * Create an empty Interaction module subset item. Module indexes will be associated to
//	 * this specific key later.
//	 *
//	 * @param name
//	 *            the identifier for this subset.
...
//
//	/**
//	 * Add a Interaction module to a given subset.
//	 *
//	 * @param linkIndex
//	 *            index of the Interaction module.
//	 * @param subsetName
...
//
//	/**
//	 * Change the mass parameters for a subset of Mass modules.
//	 *
//	 * @param newParam
...
//
//	/**
//	 * Change the stiffness parameters for a subset of Interaction modules.
//	 *
//	 * @param newParam
...
//
//	/**
//	 * Change the damping parameters for a subset of Interaction modules.
//	 *
//	 * @param newParam
...
//
//	/**
//	 * Change the resting distance parameters for a subset of Interaction modules.
//	 *
//	 * @param newParam
...
//	 */
//
//	public HapticInput3D addHapticInput3D(String name, double size, Vect3D initPos, int smoothing) {
...
//				throw new Exception("The module name already exists!");
//			}
//			inputMod = new HapticInput3D(size, initPos, smoothing);
//			mats.add(inputMod);
//			matIndexList.add(name);
//			return inputMod;
//
...
//			int mat_index = getMatIndex(matName);
//			HapticInput3D tmp;
//			if (mats.get(mat_index).getType() == massType.HAPTICINPUT3D) {
