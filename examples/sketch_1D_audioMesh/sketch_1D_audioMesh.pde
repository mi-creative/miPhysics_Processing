...
/* Bring this intelligence into the library... */

public class LinkMassConnections {
    private int mat1_index;
    private int mat2_index;
    // standard getters and setters
}

HashMap <linkModuleType, LinkMassConnections> drawLinkIndexes;
