...
void setup()
{
  ...
  miString string = new miString("string", med, 100, 0.1, 1, 0.4, 0.01, 0.1, 0.01);
  string.rotate(0, PI/2, 0);
  string.changeToFixedPoint("m_0");
  string.changeToFixedPoint("m_99");
  
  
  miString string2 = new miString("string2", med, 100, 0.1, 1, 0.4, 0.01, 0.1, 0.05);
  string2.rotate(0, PI/2, 0);
  string2.translate(0, 0.5, 0);
  ...
  phys.colEngine().addCollision(string2, perc, 0.1, 0.01);
  phys.colEngine().addCollision(string, string2, 0.01, 0.01);
