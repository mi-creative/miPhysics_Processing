...
void setup()
{
  ...
  midiCtrls.add(new midiCtrl(1, 0.0001, 0.3, "sprd", "stiffness"));
  midiCtrls.add(new midiCtrl(2, 0.00001, 0.1, "sprd", "damping"));
  midiNotes.add(new midiNote(0.1, 10, "str",0,simUGen.nbmass -1,"Y"));
}
